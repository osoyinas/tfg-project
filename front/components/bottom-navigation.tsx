...
export function BottomNavigation() {
  ...
  return (
    <>
      <div className="fixed inset-x-0 bottom-0 z-50 bg-dark-card border-t border-dark-border shadow-lg md:hidden">
        <nav className="flex h-16 items-center justify-around px-2">
          ...
          <Button
            ...
            className="flex h-full flex-col items-center justify-center gap-1 text-dark-muted-foreground hover:bg-dark-accent hover:text-dark-primary"
          >
          ...
          <Button
            ...
            className={cn(
              "flex h-full flex-col items-center justify-center gap-1 text-dark-muted-foreground hover:bg-dark-accent hover:text-dark-primary",
              pathname === "/profile" && "text-dark-primary",
            )}
          >
            <Link href="/profile">
